...
public record ManagerOrderDetailsResponseDto(
    String shopName,
    String address,
  ...
  public ManagerOrderDetailsResponseDto(Order order) {
  ...
  public static ManagerOrderDetailsResponseDto of(Order order) {
    return new ManagerOrderDetailsResponseDto(
